...
var connectionString = builder.Configuration.GetConnectionString("FilmeConnectionString");
...
builder.Services
    .AddControllers()
    .AddNewtonsoftJson(); //From NewtonSoft lib installed for AspNetCore.Mvc
